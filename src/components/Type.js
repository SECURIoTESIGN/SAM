...
import {useStyles} from './TypeStyles';
...
class Type extends Component{
  ...
  handle_add_edit_resource = () => {
    ...
    // Form validation
    if (!this.state.resource.name || !this.state.resource.description){
    ...
    json_obj['name']     = this.state.resource.name;
        ...
        <table className={classes.table}>
          ...
          <tbody><tr>
            <td>
              ...
              <Typography className={classes.fields} color="textSecondary" align="justify" variant='subtitle2'>To link {resource_name_plural} and modules please visit the 'Module' section of the administration panel.</Typography>
            </td>
          </tr></tbody>
          <tbody><tr>
            <td>
...
export default withStyles(useStyles)(Type)