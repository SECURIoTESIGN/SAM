...
import {useStyles} from './AddModuleStyles';
      ...
      'Content-Type': 'application/json'
        ...
        switch (response[serviceURL]['status']){
          ...
          case 200:{
            ...
            if (DEBUG) console.log("[SAM] get_modules() = " + s_modules)
  ...
  render(){
    ...
    return(
      ...
      <PopupComponent title="Link Questions" open={this.state.open_tree} onClose={() => {this.setState({open_tree: false})}} TransitionComponent={Transition}>
        <TreeComponent module={2} onSave={this.get_tree_data}/>
      </PopupComponent>
      ...
      <div className={classes.root}>
        <div className={classes.title}>
          ...
          <tbody><tr>
            ...
            <td><Typography color="textPrimary" gutterBottom>Register Module</Typography></td>
          </tr></tbody>
          </table>
        </div>
          ...
          <tbody><tr>
            <td width="80%">
              <TextField required id="tf_fullname" name="tf_fullname" onChange={event => this.setState({module:{...this.state.module,fullname: event.target.value}})} label="Name" variant="outlined" margin="normal" fullWidth />
            </td>
            <td width="20%">
              <TextField required id="tf_shortname" name="tf_shortname" onChange={event => this.setState({module:{...this.state.module,shortname: event.target.value}})}  label="Abbrev." variant="outlined" margin="normal" fullWidth />
            </td>
          </tr></tbody>
          <tbody><tr>
            <td>
              <TextField required id="tf_displayname" name="tf_displayname" className={classes.text} onChange={event => this.setState({module:{...this.state.module,displayname: event.target.value}})}  label="Display Name"  variant="outlined" margin="normal" fullWidth />
            </td>
            <td width="20%">
              <FormControl className={classes.formControl}>
                  <InputLabel htmlFor="s_module_type">Type</InputLabel>
          ...
          <tbody><tr>
            <td colSpan="2">
              <FormControl>
                ...
                <Select style={{width: 500}}  defaultValue="" onChange={event => this.setState({module:{...this.state.module,dependency: event.target.value}})}>
                  <MenuItem value=""/>
                  {this.state.modules.map((module) => (
                    <MenuItem value={module['id']}>{module['fullname']}</MenuItem>
                  ))}
                </Select>
              </FormControl>
            </td>
...
export default withStyles(useStyles)(AddModule)