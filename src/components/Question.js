          ...
          <table className={classes.table}>
            ...
            <tbody><tr>
              <td>
                ...
                <Typography className={classes.fields} align="justify" color="textSecondary" variant='subtitle2'>To link {resource_name_plural} and modules please visit the 'Module' section of the administration panel.</Typography>
              </td>
            </tr></tbody>
            <tbody><tr>
              <td>
